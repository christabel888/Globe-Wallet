...
- [App Shell & Accessibility: Safe-Area, Nav Semantics, A11y Tests (Issue #16)](docs/issue-16.md) - viewport-fit=cover, safe-area-inset helpers, BottomNav role/focus fixes, PageHeader landmark, ShellService, GET /api/shell, and full test suite.
